...
describe('Validate correct eligibility benefits display based on selected criteria/options', () => {
  it('qa scenario 1 EN - Verify correct benefit results for query values that includes covid in search parameter of URL', () => {

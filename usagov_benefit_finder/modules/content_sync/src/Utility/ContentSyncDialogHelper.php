...
class ContentSyncDialogHelper {
  ...
  public static function attachLibraries(array &$build) {
    ...
    if (\Drupal::moduleHandler()->moduleExists('imce') && Imce::access()) {
      ...
      $image_path = \Drupal::service('extension.list.module')->getPath('imce') . '/js/plugins/ckeditor/icons/imceimage.png';
      $element['#attached']['drupalSettings']['content_sync']['html_editor']['ImceImageIcon'] = \Drupal::service('file_url_generator')->generateAbsoluteString($image_path);    }
  }
